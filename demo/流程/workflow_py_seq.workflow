...
<Flow name="py_seq.sequence" sid="string" desc="" namespace="RPA.AutoTest" dll="">
  <GVars/>
  <Params/>
  <Vars/>
  <Steps>
    <FlowStart name="Start" sid="123" desc="Start" control="" nodeid="1">
      <canvas>
        <avNode id="1" name="Start" title="开始" opertype="RootStart" Description="Start" endpoints="[object Object]" nodeTag="FlowStart" consoleErrorTip="false" top="20" left="460" drawId="draw5" _global="[object Object]" draggable="true"/>
      </canvas>
      <args/>
    </FlowStart>
    <FlowStep name="ClearPythonFunc" sid="123" sAssembly="RPA.Common.Activity" desc="调用Python函数" control="" nodeid="3" breakPoint="false" annoteShow="false">
      <canvas>
        <avNode id="3" title="调用Python函数" top="180" left="400" drawId="draw5" endpoints="[object Object],[object Object]" errMsg="" name="ClearPythonFunc" annotation="使用本地Python环境运行Python代码脚本，需要预装Python及依赖包。" opertype="脚本运行" Description="调用Python函数" index="2" GdesOperationType="" systemType="windows,linux" sAssembly="RPA.Common.Activity" control="false" number="Robot-Common-006" nodeTag="FlowStep" args="[object Object],[object Object],[object Object],[object Object],[object Object],[object Object]" _global="[object Object]" draggable="true" breakShow="false" annoteShow="false" consoleErrorTip="false" breakPoint="false"/>
      </canvas>
      <args>
        <ParamBinding name="ScriptPath" value="流程/代码文件/Python脚本" title="执行路径"/>
        <ParamBinding name="ScriptName" value="test.py" title="脚本文件名"/>
        <ParamBinding name="FuncName" value="demofunc" title="调用函数名"/>
        <ParamBinding name="InputArgs" value="参数1 参数2" title="输入参数"/>
        <ParamBinding name="TimeOut" value="60" title="执行超时(S)"/>
        <ParamBinding name="VarName" value="var1" title="输出-变量名"/>
      </args>
    </FlowStep>
